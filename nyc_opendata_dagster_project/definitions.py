...
from nyc_opendata_dagster_project.jobs import nyc311_job, nypd_arrest_job, nypd_per_partition_job
...
all_jobs = [nyc311_job, nypd_arrest_job, nypd_per_partition_job]
